		...
		<div id="main">
			...
			<div id="bodydates" style="background: white;">
				...
				<c:forEach var="tempFlight" items="${restFlights}">
					...
					<c:url var="datelink" value="/processForm"> 
			...
			<div id="sum">
				...
				<div id="returnflight">
					<c:url var="arrivalFlight" value="/processForm2">
						<c:param name="destinationPlace" value="${flight.arrival.arrivalPlace }" />
						<c:param name="arrivalPlace" value="${flight.departure.departurePlace }" />
	 					<c:param name="date" value="${flight.departureDate}" /> 
						<c:param name="flightClass" value="${flightClass }" />
						<c:param name="numberOfPassangers" value="${numberOfPassangers}" />
						<c:param name="firstflightnumber" value="${flight.flightNumber }" />
						<c:param name="fp" value="${fullprice}" />
					</c:url>

					<input type="submit" value="add return flight" id="arf" onclick="check('${arrivalFlight}')" />
				</div>
			</div>
			<div id="next">
				<c:url var="arrivalFlight2" value="/client-details">
					<c:param name="flightClass" value="${flightClass }" />
					<c:param name="numberOfPassangers" value="${numberOfPassangers}" />
					<c:param name="firstflightnumber" value="${flight.flightNumber }" />
					<c:param name="secondflightnumber" value="null" />
				</c:url>
		
				<input type="submit" value="next" id="submit" onclick="check('${arrivalFlight2}')" />
			</div>
